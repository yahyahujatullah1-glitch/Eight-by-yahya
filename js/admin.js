...
// --- CONFIG ---
const CREDENTIALS = { user: "starcity@admin", pass: "star0312" };
let db = []; // MySQL Data
...
// ==========================================
// 3. MYSQL DATA (Players & Admins)
// ==========================================
async function renderPlayerTable() {
    try {
        const response = await fetch('/api/players'); // Calls the Vercel API
        ...
        showToast("MySQL Connection Failed", "red");
        console.error(error);
    }
}
